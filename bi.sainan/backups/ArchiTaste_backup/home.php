...
<div class="container">
   ...
   <h1 class="text-center" style="font-weight: normal; font-size: 1.8em;">- Premiere Selection -</h1>
   ...
   <h1 class="text-center" style="font-weight: normal; font-size: 1.8em;">- New Arrivals -</h1>
