...
$empty_product = (object)[
	...
	"quantity"=>"4",
	"category"=>"Drinking",
	"description"=>"Test mug: Does this add form work?",
	"thumbnail"=>"img/600_size/giraffe_mug_blue_table_full_600.jpg",
	"images"=>"img/600_size/giraffe_mug_blue_close_full_600.jpg,img/600_size/giraffe_mug_blue_full_600.jpg"
];
...
<form method="post" action="{$_SERVER['PHP_SELF']}?id=$id&action=$createorupdate">	
	...
	<div class="form-control">
		...
		<input type="text" class="form-input" name="product-name" id="product-name" value="$o->name" placeholder=" Enter Product Name">
	</div>
	<div class="form-control">
		<label class="form-label" for="product-price">Price</label>
		<input class="form-input" name="product-price" id="product-price" type="Number" min="0" max="1000" step="0.01" value="$o->price" placeholder=" Enter Product Price">
	</div>
	<div class="form-control">
		<label class="form-label" for="product-quantity">Quantity</label>
		<input class="form-input" name="product-quantity" id="product-quantity" type="Number" min="0" max="1000" step="1" value="$o->quantity" placeholder=" Enter Product Quantity">
	</div>
	<div class="form-control">
